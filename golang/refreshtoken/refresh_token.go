...
func createRefreshToken(u model.User) (string, error) {
...
func verifyRefreshToken(refreshToken string) (model.User, error) {
	c := &claims.UserClaims{}
	...
	if err != nil {
		return model.User{}, fmt.Errorf("parse parse failed: %w", err)
	}
	...
	idx := slices.IndexFunc(usersDB, func(u model.User) bool {
